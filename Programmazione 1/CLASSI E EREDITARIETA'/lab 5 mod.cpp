...
class A{
	...
	double& operator [] (int i)    //operator [] , si usa solitamente per prendere un elemento dell'array contenuto in un oggetto, 
	{                                  //    deve essere operatore membro e restituisce reference in modo tale da 
		return w[i%len];                        // rendere possibile l'assegnamento
	}	
